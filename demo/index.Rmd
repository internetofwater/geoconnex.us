...
## PWS
pws <- sf::read_sf("https://reference.geoconnex.us/collections/pws/items?ST=NM&limit=6000")
pws <- pws[huc8,]
...
### Reference Gages
gages <- sf::read_sf("https://reference.geoconnex.us/collections/gages/items?limit=100000000")
gages <- gages[huc8,]
...
We can use the NLDI to find [USGS National Water Information System (NWIS)](https://waterdata.usgs.gov/nwis?wat) Sites and WaDE sites (which are also available from the Reference Gages feature collection in [reference.geoconnex.us](https://geoconnex.us) and from WaDE itself from [wade-test.geoconnex.us](https://wade-test.geoconnex.us), respectively), as well as [Water Quality Portal (WQP)](https://www.waterqualitydata.us/) Sites. In the future, any organizations interested in participating in Geoconnex should also consider adding their location metadata to the NLDI. 
