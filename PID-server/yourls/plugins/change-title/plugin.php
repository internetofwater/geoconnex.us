...
Description: Changes the title of the admin page
Version: 0.1
Author: Kyle Onda
Author URI: https://kyleonda.com
*/
...
yourls_add_action( 'admin_menu', 'kso_sample_add_menu' );
/* This says: when YOURLS does action 'admin_menu', call function 'ozh_sample_add_menu'
 */

function kso_sample_add_menu() {
	echo '<li><a href="https://kyleonda.com">Kso</a></li>';
}
...
yourls_add_filter( 'html_title', 'kso_sample_change_title' );
/* This says: when filter 'html_title' is triggered, send its value to function 'kso_sample_change_title'
 * and use what this function will return.
 */
 
function kso_sample_change_title( $value ) {
	$value = 'geoconnex.us PID registry admin';
